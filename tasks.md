...
- [x] Backend: Crear `tests/test_debt_simplifier.py` con pruebas unitarias en `pytest` para `simplify_household_debts`, cubriendo: hogar sin tesorero (modo greedy), hogar con tesorero asignado, y un hogar donde el tesorero tiene saldo neto propio.
